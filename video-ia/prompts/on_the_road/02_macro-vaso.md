...
**Video** `on_the_road` · **In** 2.23 s · **Out** 3.07 s · **Duracion** 0.83 s (25 frames)  
**Tipo** macro · **Camara** fija, dolly in muy corto · **Sujeto** vaso de refresco con hielo  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_02.57.png`

> **Por que existe este plano:** Segundo inserto: instala el ritual antes de mostrar al hombre.
...
Close-up of a heavy fluted glass of dark cola over crushed ice on a formica counter, condensation beading down the outside, a dark-skinned hand closing around it. The burger far out of focus behind. Warm window light from camera-left, hard highlight down the near edge of the glass.
```
...
ACTION: The hand closes around the glass and lifts it two centimetres. The ice settles and shifts. Condensation runs down.
CAMERA: static shot with a very slow push in, macro lens.
...
SFX: ice settling in glass, a low hum of a refrigeration unit.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 0.83 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 0.83 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 0.83 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 0.83 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 0.83 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 01 · **Siguiente:** plano 03  
