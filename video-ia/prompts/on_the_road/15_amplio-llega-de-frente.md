# Plano 15 — amplio llega de frente

**Video** `on_the_road` · **In** 24.17 s · **Out** 24.97 s · **Duracion** 0.80 s (24 frames)  
**Tipo** amplio · **Camara** fija baja, el coche crece hacia camara · **Sujeto** COCHE + UBICACION carretera  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_24.49.png`

> **Por que existe este plano:** Establece el tercer mundo: mesetas rojas, asfalto, horizonte.
...
Low wide shot from the centre of the blacktop at knee height, the yellow car coming head-on down the two-lane highway from the middle distance, rust-red mesas on both sides, telegraph poles on the right, broken yellow centre line running under the lens. Low sun almost head-on, heavy ochre dust.
```
...
ACTION: The car comes straight at camera, growing in the frame, dust boiling out behind it, and passes just off the lens at the end.
CAMERA: static shot at ground level, locked off.
...
SFX: engine approaching and doppler-shifting past, air blast.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 0.80 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 0.80 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 0.80 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 0.80 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 0.80 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 14 · **Siguiente:** plano 16  
