# Plano 24 — amplio frontal max

**Video** `on_the_road` · **In** 32.47 s · **Out** 32.97 s · **Duracion** 0.50 s (15 frames)  
**Tipo** amplio · **Camara** travelling frontal · **Sujeto** COCHE  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_32.67.png`

> **Por que existe este plano:** Golpe de escala en medio de la rafaga.
...
Front three-quarter view of the yellow car at full speed, low and close, the grille and both round headlamps square to the lens, the two black stripes running back over the bonnet, dust exploding off both sides. Mesas streaking behind.
```
...
ACTION: The car bears down on the lens at full speed, the front end filling more of the frame each moment, dust tearing off both flanks.
CAMERA: tracking shot moving backwards ahead of the subject, matched speed.
...
SFX: engine at full throttle, air pressure.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 0.50 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 0.50 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 0.50 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 0.50 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 0.50 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 23 · **Siguiente:** plano 25  
