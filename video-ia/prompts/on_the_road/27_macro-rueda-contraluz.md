# Plano 27 — macro rueda contraluz

**Video** `on_the_road` · **In** 35.27 s · **Out** 37.40 s · **Duracion** 2.13 s (64 frames)  
**Tipo** macro · **Camara** travelling bajo a contraluz · **Sujeto** PROP rueda contra el sol  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_36.12.png`

> **Por que existe este plano:** Empieza a disolver la imagen en luz: preparacion del final.
...
Low backlit close-up of the spinning rear wheel with the low sun directly behind it, the spokes reading as a dark silhouette against heavy flare, dust and grit lit in the beam, the yellow arch a thin bright edge above.
```
...
ACTION: The wheel spins against the sun, the flare pulsing as the spokes cut through it, dust streaming through the light.
CAMERA: low tracking shot at ground level, matched speed, backlit.
...
|---|---|---|
| `duration` | 4 | El plano dura 2.13 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 2.13 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 2.13 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 2.13 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 2.13 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 26 · **Siguiente:** plano 28  
