# Plano 17 — macro rueda aleta

**Video** `on_the_road` · **In** 26.13 s · **Out** 27.17 s · **Duracion** 1.03 s (31 frames)  
**Tipo** macro · **Camara** travelling pegado a la carroceria · **Sujeto** PROP rueda y aleta  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_26.55.png`

> **Por que existe este plano:** Detalle de fabricacion: el logo pintado vende que el coche existe.
...
Tight tracking close-up of the front wheel and the riveted yellow arch extension above it, the deep-dish alloy blurred into a disc, painted lettering on the flank cut by the frame. Blacktop streaking underneath. Low warm light.
```
...
ACTION: The wheel spins, the arch stays locked in frame, the road tears past underneath in a horizontal blur.
CAMERA: low tracking shot alongside the moving car, macro lens, matched speed.
...
SFX: tyre roar on coarse asphalt, suspension.
```
...
**Anterior:** plano 16 · **Siguiente:** plano 18  
