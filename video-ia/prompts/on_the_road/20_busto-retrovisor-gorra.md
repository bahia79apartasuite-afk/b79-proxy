# Plano 20 — busto retrovisor gorra

**Video** `on_the_road` · **In** 29.70 s · **Out** 30.30 s · **Duracion** 0.60 s (18 frames)  
**Tipo** busto · **Camara** fija sobre el retrovisor · **Sujeto** PROTAGONISTA reflejado  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_29.94.png`

> **Por que existe este plano:** Segundo reflejo. Recordar la cara justo antes de que el montaje se vuelva abstracto.
...
Close-up through the windscreen from outside and slightly above, THE DRIVER's face and the navy cap framed by the top of the windscreen and the wiper, the desert reflected across the glass. His eyes are on the road.
```
...
ACTION: He holds his line, eyes forward, the reflection of the mesas sliding continuously across the glass in front of his face.
CAMERA: static shot mounted on the bonnet, locked off.
...
SFX: wind over the screen, engine muted through glass.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 0.60 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 0.60 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 0.60 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 0.60 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 0.60 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 19 · **Siguiente:** plano 21  
