# Plano 23 — macro rueda asfalto

**Video** `on_the_road` · **In** 32.13 s · **Out** 32.47 s · **Duracion** 0.33 s (10 frames)  
**Tipo** macro · **Camara** travelling muy bajo junto a la rueda · **Sujeto** PROP rueda  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_32.27.png`

> **Por que existe este plano:** Plano de 10 frames. Aqui empieza la aceleracion del montaje.
...
Very low tracking close-up alongside the moving front wheel, camera almost on the road surface, the spokes blurred into a solid disc, the blacktop streaking underneath, a white pickup far out of focus ahead. Hard low light.
```
...
ACTION: The wheel spins, the asphalt tears past underneath in a hard horizontal blur, a stone flicks up off the tread.
CAMERA: low tracking shot at ground level, matched speed, macro lens.
...
**Anterior:** plano 22 · **Siguiente:** plano 24  
