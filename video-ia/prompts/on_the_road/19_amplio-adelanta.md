# Plano 19 — amplio adelanta

**Video** `on_the_road` · **In** 28.03 s · **Out** 29.70 s · **Duracion** 1.67 s (50 frames)  
**Tipo** amplio · **Camara** seguimiento desde atras · **Sujeto** COCHE + trafico  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_28.70.png`

> **Por que existe este plano:** Mete riesgo: por primera vez hay algo mas en la carretera.
...
Shot from behind and above the yellow car as it runs between a box truck on the left and a white pickup on the right, the three vehicles filling the two lanes, telegraph poles and mesas ahead, dust in the air.
```
...
ACTION: The yellow car pulls forward between the two larger vehicles and draws away from them down the road. The camera follows from behind and slightly above.
CAMERA: tracking shot from behind, slightly high.
...
SFX: engine pulling hard, truck air horn, wind buffet.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 1.67 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 1.67 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 1.67 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 1.67 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 1.67 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 18 · **Siguiente:** plano 20  
