# Plano 08 — macro tacometro

**Video** `on_the_road` · **In** 12.87 s · **Out** 13.63 s · **Duracion** 0.77 s (23 frames)  
**Tipo** macro · **Camara** macro fija · **Sujeto** PROP cuadro de instrumentos  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_13.17.png`

> **Por que existe este plano:** Traduce el sonido en imagen. Aqui es donde el montaje pide musica.
...
Extreme close-up of the centre dial of a three-gauge cluster in a matte black binnacle behind a chromed bezel, white needle, cream numerals on a black face, the outer dials cut by the frame edges. Scratched glass with a hard reflection across it. Warm interior light from camera-left.
```
...
ACTION: The needle swings up past the middle of its arc, hangs, and falls back. The reflection slides across the glass as the whole cluster vibrates.
...
SFX: engine revving hard and dropping back to idle.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 0.77 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 0.77 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 0.77 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 0.77 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 0.77 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 07 · **Siguiente:** plano 09  
