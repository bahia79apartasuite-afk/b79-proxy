# Plano 25 — cenital carretera

**Video** `on_the_road` · **In** 32.97 s · **Out** 34.17 s · **Duracion** 1.20 s (36 frames)  
**Tipo** amplio · **Camara** cenital alto (dron) · **Sujeto** UBICACION carretera  
**Frame de referencia del original:** `analysis/on_the_road/frames/t_33.45.png`

> **Por que existe este plano:** Aire. Sin este plano la rafaga final agota.
...
Top-down aerial view from 120 metres, the highway a thin dark ribbon crossing red rock and scrub, the broken centre line reading as a dotted graphic line, two tiny vehicles on it far apart, a thread of dust behind the leading one.
```
...
ACTION: The two vehicles crawl along the ribbon, the gap between them slowly closing. The camera holds still and high.
CAMERA: top-down aerial view, static, high altitude.
...
SFX: wind at altitude, engines very distant.
```
...
|---|---|---|
| `duration` | 4 | El plano dura 1.20 s, pero Seedance no genera clips de menos de 4 s. Se generan 4 s y en el montaje se recortan 1.20 s del centro, que es donde el movimiento ya esta asentado. |
...
> **Duracion:** **El plano dura 1.20 s, pero Seedance no genera clips de menos de 4 s.** Se generan 4 s y en el montaje se recortan 1.20 s del centro, que es donde el movimiento ya esta asentado. Los primeros frames de un clip generado casi siempre arrancan con un titubeo.
...
- [ ] ¿Hay al menos 1.20 s utiles seguidos, sin el titubeo del arranque?
...
**Anterior:** plano 24 · **Siguiente:** plano 26  
