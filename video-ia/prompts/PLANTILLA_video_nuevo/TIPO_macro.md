...
**Tipo** macro · **Camara** [de BANCO_CAMARA.md] · **Sujeto** [quien o que]
...
[ENCUADRE] [Extreme close-up | Macro close-up] of [EL OBJETO], [que lo toca o que hace],
[que hay detras, far out of focus], [luz con direccion], shallow depth of field.
The face is NOT in frame.
```
...
**Especifico del macro:**

- [ ] ¿Se cuela media cara en el borde? Es el fallo tipico. `The face is NOT in frame` lo evita.
- [ ] ¿El desenfoque se lee como camara y no como fondo pintado?
- [ ] ¿Se entiende la escala del objeto?
- [ ] **¿Has adjuntado la referencia del personaje?** Si el personaje no sale, **quitala**.
      Cada referencia de mas empuja al modelo a usarla.
